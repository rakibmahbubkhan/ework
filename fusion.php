					...
					<div class="form-group row">
						...
						<div class="col-lg-9">
							<div class="input-group">
								...
								</div><input class="form-control" name="oldPassword" type="hidden" value="<?php echo $row['password']; ?>"> <input autocomplete="New Password" class="form-control" name="newPassword" type="password">
							</div>
						</div>
